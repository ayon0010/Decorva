    ...
    return (
        <div className='p-3 flex flex-col gap-4'>
            <div className='flex items-start gap-6'>
                ...
                <textarea name="advanced" id="advanced" placeholder='Purchase Note' className='border px-2 py-1 border-black/30 rounded-sm w-full max-w-[300px] placeholder:text-xs' />
            </div>
            <div className='flex items-start gap-6'>
